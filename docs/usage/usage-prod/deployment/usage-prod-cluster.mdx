...
TiKV 是TiDB的底层引擎，非常成熟。可以参考 [tikv-in-5-minutes](https://tikv.org/docs/dev/concepts/tikv-in-5-minutes/#set-up-a-local-tikv-cluster-with-the-default-options) 部署。
